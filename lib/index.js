...
var search = $('#search');
  ...
  Task.prototype.toHTML = function() {
    ...
    return (`
      <li class="task-card ${this.completed}" id=${this.id}>
        <header class="bottom-header">
          ...
          <h3 contenteditable="true" class=${completed}>${this.title}</h3>
        </header>
        <p contenteditable="true" class=${completed} id="card-body">${this.body}</p>
        <footer>
    ...
    Task.prototype.rendorTitleAndBody = function() {
      $('h3').toggleClass('strikethrough');
