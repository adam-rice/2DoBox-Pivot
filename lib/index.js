  ...
  Task.prototype.toHTML = function() {
    ...
    return (`
      <li class="task-card ${this.completed}" id=${this.id}>
        ...
        <footer>
          <button class="upvote" name="upvote">upvote</button><button class="downvote">downvote</button>
          <h4>
            importance:<span name="importance" class="importance-change"> ${this.importance}</span>
          </h4>
        </footer>
      </li>
      `);
